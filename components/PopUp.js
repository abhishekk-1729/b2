...
export default function PopUp({setOpenModel,getDonations,donate,donateFunction}) {
    ...
    useEffect(()=>{
        ...
        return async () => {
            setAllDonations(await getDonations());
        }
    },[])
    ...
    <div>
        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            ...
            {/*content*/}
                ...
                {/*header*/}
                    <div className="flex items-start justify-between p-5 border-b border-solid border-slate-20 rounded-t">
